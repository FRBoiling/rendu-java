...
public final class Z2M {
  ...
  private static final long serialVersionUID = 0L;
    ...
    public static final com.google.protobuf.Descriptors.Descriptor
        getDescriptor() {
      return Z2M.internal_static_protocol_zone_manager_MSG_Z2M_HEARTBEAT_descriptor;
    }

    protected FieldAccessorTable
        internalGetFieldAccessorTable() {
      return Z2M.internal_static_protocol_zone_manager_MSG_Z2M_HEARTBEAT_fieldAccessorTable
          .ensureFieldAccessorsInitialized(
              MSG_Z2M_HEARTBEAT.class, Builder.class);
    }
    ...
    public boolean equals(final Object obj) {
      ...
      if (!(obj instanceof MSG_Z2M_HEARTBEAT)) {
        return super.equals(obj);
      }
      MSG_Z2M_HEARTBEAT other = (MSG_Z2M_HEARTBEAT) obj;
    ...
    public static MSG_Z2M_HEARTBEAT parseFrom(
    ...
    public static MSG_Z2M_HEARTBEAT parseFrom(byte[] data)
        throws com.google.protobuf.InvalidProtocolBufferException {
      return PARSER.parseFrom(data);
    }
    public static MSG_Z2M_HEARTBEAT parseFrom(
    ...
    public static MSG_Z2M_HEARTBEAT parseFrom(java.io.InputStream input)
        throws java.io.IOException {
    ...
    public static MSG_Z2M_HEARTBEAT parseDelimitedFrom(java.io.InputStream input)
        throws java.io.IOException {
      return com.google.protobuf.GeneratedMessageV3
          .parseDelimitedWithIOException(PARSER, input);
    }
    public static MSG_Z2M_HEARTBEAT parseDelimitedFrom(
        java.io.InputStream input,
        com.google.protobuf.ExtensionRegistryLite extensionRegistry)
        throws java.io.IOException {
      return com.google.protobuf.GeneratedMessageV3
    ...
    public static Builder newBuilder(MSG_Z2M_HEARTBEAT prototype) {
    ...
    public static final class Builder extends
      ...
      public MSG_Z2M_HEARTBEAT getDefaultInstanceForType() {
        return MSG_Z2M_HEARTBEAT.getDefaultInstance();
      }

      public MSG_Z2M_HEARTBEAT build() {
        MSG_Z2M_HEARTBEAT result = buildPartial();
      ...
      public MSG_Z2M_HEARTBEAT buildPartial() {
        MSG_Z2M_HEARTBEAT result = new MSG_Z2M_HEARTBEAT(this);
        onBuilt();
        return result;
      }
      ...
      public Builder mergeFrom(com.google.protobuf.Message other) {
        if (other instanceof MSG_Z2M_HEARTBEAT) {
          return mergeFrom((MSG_Z2M_HEARTBEAT)other);
        } else {
      ...
      public Builder mergeFrom(MSG_Z2M_HEARTBEAT other) {
        if (other == MSG_Z2M_HEARTBEAT.getDefaultInstance()) return this;
      ...
      public Builder mergeFrom(
          ...
          com.google.protobuf.ExtensionRegistryLite extensionRegistry)
          throws java.io.IOException {
        MSG_Z2M_HEARTBEAT parsedMessage = null;
        try {
          parsedMessage = PARSER.parsePartialFrom(input, extensionRegistry);
        } catch (com.google.protobuf.InvalidProtocolBufferException e) {
          parsedMessage = (MSG_Z2M_HEARTBEAT) e.getUnfinishedMessage();
    ...
    private static final MSG_Z2M_HEARTBEAT DEFAULT_INSTANCE;
    static {
      DEFAULT_INSTANCE = new MSG_Z2M_HEARTBEAT();
    }

    public static MSG_Z2M_HEARTBEAT getDefaultInstance() {
      return DEFAULT_INSTANCE;
    }

    @Deprecated public static final com.google.protobuf.Parser<MSG_Z2M_HEARTBEAT>
