...
public final class R2GM {
  ...
  private static final long serialVersionUID = 0L;
    ...
    public static final com.google.protobuf.Descriptors.Descriptor
        getDescriptor() {
      return R2GM.internal_static_protocol_relation_global_MSG_R2GM_HEARTBEAT_descriptor;
    }

    protected FieldAccessorTable
        internalGetFieldAccessorTable() {
      return R2GM.internal_static_protocol_relation_global_MSG_R2GM_HEARTBEAT_fieldAccessorTable
          .ensureFieldAccessorsInitialized(
              MSG_R2GM_HEARTBEAT.class, Builder.class);
    }
    ...
    public boolean equals(final Object obj) {
      ...
      if (!(obj instanceof MSG_R2GM_HEARTBEAT)) {
        return super.equals(obj);
      }
      MSG_R2GM_HEARTBEAT other = (MSG_R2GM_HEARTBEAT) obj;
    ...
    public static MSG_R2GM_HEARTBEAT parseFrom(
    ...
    public static MSG_R2GM_HEARTBEAT parseFrom(byte[] data)
        throws com.google.protobuf.InvalidProtocolBufferException {
      return PARSER.parseFrom(data);
    }
    public static MSG_R2GM_HEARTBEAT parseFrom(
    ...
    public static MSG_R2GM_HEARTBEAT parseFrom(java.io.InputStream input)
        throws java.io.IOException {
    ...
    public static MSG_R2GM_HEARTBEAT parseDelimitedFrom(java.io.InputStream input)
        throws java.io.IOException {
      return com.google.protobuf.GeneratedMessageV3
          .parseDelimitedWithIOException(PARSER, input);
    }
    public static MSG_R2GM_HEARTBEAT parseDelimitedFrom(
        java.io.InputStream input,
        com.google.protobuf.ExtensionRegistryLite extensionRegistry)
        throws java.io.IOException {
      return com.google.protobuf.GeneratedMessageV3
    ...
    public static Builder newBuilder(MSG_R2GM_HEARTBEAT prototype) {
    ...
    public static final class Builder extends
      ...
      public MSG_R2GM_HEARTBEAT getDefaultInstanceForType() {
        return MSG_R2GM_HEARTBEAT.getDefaultInstance();
      }

      public MSG_R2GM_HEARTBEAT build() {
        MSG_R2GM_HEARTBEAT result = buildPartial();
      ...
      public MSG_R2GM_HEARTBEAT buildPartial() {
        MSG_R2GM_HEARTBEAT result = new MSG_R2GM_HEARTBEAT(this);
        onBuilt();
        return result;
      }
      ...
      public Builder mergeFrom(com.google.protobuf.Message other) {
        if (other instanceof MSG_R2GM_HEARTBEAT) {
          return mergeFrom((MSG_R2GM_HEARTBEAT)other);
        } else {
      ...
      public Builder mergeFrom(MSG_R2GM_HEARTBEAT other) {
        if (other == MSG_R2GM_HEARTBEAT.getDefaultInstance()) return this;
      ...
      public Builder mergeFrom(
          ...
          com.google.protobuf.ExtensionRegistryLite extensionRegistry)
          throws java.io.IOException {
        MSG_R2GM_HEARTBEAT parsedMessage = null;
        try {
          parsedMessage = PARSER.parsePartialFrom(input, extensionRegistry);
        } catch (com.google.protobuf.InvalidProtocolBufferException e) {
          parsedMessage = (MSG_R2GM_HEARTBEAT) e.getUnfinishedMessage();
    ...
    private static final MSG_R2GM_HEARTBEAT DEFAULT_INSTANCE;
    static {
      DEFAULT_INSTANCE = new MSG_R2GM_HEARTBEAT();
    }

    public static MSG_R2GM_HEARTBEAT getDefaultInstance() {
      return DEFAULT_INSTANCE;
    }

    @Deprecated public static final com.google.protobuf.Parser<MSG_R2GM_HEARTBEAT>
